...
EditText c,s,d;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Firebase.setAndroidContext(ComplainActivity.this);
        ur = new Firebase("https://complainreportapp.firebaseio.com/");
        ...
        userkaemail=getIntent().getStringExtra("Email");

ShowC.setOnClickListener(new View.OnClickListener() {
    @Override
    public void onClick(View view) {
        Intent i=new Intent(ComplainActivity.this,ReportShowActivity.class);
        startActivity(i);
    }
});
        ...
        jUser = new User();
        jDatabase = new Database(ComplainActivity.this);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
      ...
      final Bitmap bitmap = BitmapFactory.decodeFile(pathfile);
            ...
            if (isLocationEnabled(ComplainActivity.this)) {
                ...
                if (location != null) {
                    ...
                    Toast.makeText(ComplainActivity.this, "latitude:" + latitude + " longitude:" + longitude, Toast.LENGTH_SHORT).show();
                    ...
                    save.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                           ...
                           firebase.setValue(userkaemail);
                            ...
                            firebase = ur.child("Lattitue");
                            firebase.setValue(latitude);
                            firebase = ur.child("Longitude");
                            firebase.setValue(longitude);
                            Toast.makeText(ComplainActivity.this,"Data Send Successfuly To Server Firebase!",Toast.LENGTH_LONG).show();
                    ...
                    sqmaisave.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View view) {
                            jUser.setCat(c.getText().toString().trim());
                            jUser.setSev(s.getText().toString().trim());
                            jUser.setDes(d.getText().toString().trim());
                            jUser.setLat(latitude);
                            jUser.setLon(longitude);
                            jUser.setIm(String.valueOf(uri));
                            jUser.setUserEmail(userkaemail);
                            jDatabase.insertData(jUser);

                            Toast.makeText(ComplainActivity.this,"Your Complain has been Saved!",Toast.LENGTH_LONG).show();
                        }
                    });
            ...
            {
                Toast.makeText(ComplainActivity.this, "Enable Location", Toast.LENGTH_SHORT).show();
            }
   ...
   /* protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
    ...
    private void dispatchPic() {
        ...
        if(i.resolveActivity(getPackageManager()) !=null){
            ...
            if(f != null) {
                ...
                uri= FileProvider.getUriForFile(ComplainActivity.this,"com.lab.complainreport.fileprovider",f);
    ...
    public void onLocationChanged(Location location) {
        ...
        latitude = location.getLatitude();
        longitude = location.getLongitude();
        Toast.makeText(ComplainActivity.this, "Jaaaanlatitude:" + latitude + " longitude:" + longitude, Toast.LENGTH_SHORT).show();
            ...
            ref.putFile(uri)
                    .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            Toast.makeText(ComplainActivity.this, "Uploaded", Toast.LENGTH_SHORT).show();
                        }
                    })
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            progressDialog.dismiss();
                            Toast.makeText(ComplainActivity.this, "Failed "+e.getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    })
