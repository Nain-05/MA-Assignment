...
class MyDatabaseHelper extends SQLiteOpenHelper {
    ...
    private static final String COLUMN_SUBJECT = "note_subject";
    ...
    void addNote(String title, String author){
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues cv = new ContentValues();

        cv.put(COLUMN_SUBJECT, title);
        cv.put(COLUMN_BODY, author);
    ...
    void updateData(String row_id, String subject, String body){
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues cv = new ContentValues();
